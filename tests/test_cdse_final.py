...
from src.search.fetch_CDSE import cdse, DEFAULT_BBOX
...
def test_cdse_logic_and_defaults(mock_mkdir, mock_save, mock_stac, mock_events):
    ...
    assert kwargs['datetime'] == "2024-01-05/2024-01-16"
...
def test_sentinel_1_multi_band_call(mock_save, mock_stac, mock_events):
    ...
    mock_stac.return_value.search.return_value.item_collection.return_value = [mock_item]
...
def test_csv_output_generation(mock_process, tmp_path):
    ...
    with patch('pandas.DataFrame.to_csv') as mock_to_csv:
        cdse([{"id": "E1", "start_date": "2024-01-01", "end_date": "2024-01-02", 
               "pre_event_days": 1, "post_event_days": 1}])
